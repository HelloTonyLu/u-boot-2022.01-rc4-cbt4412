...
uboot_size=$((1024*1024))	#1MB
kernal_size=$((10240*1024))	#10MB
dtb_size=$((16*1024))	#16KB
...
dtb_position=$((kernel_position+uboot_size/block))
...
echo dtb_position = $dtb_position
...
echo "---------------------------------------"
echo "dtb fusing"
dd iflag=dsync oflag=dsync if=${DTB} of=$1 seek=$dtb_position
